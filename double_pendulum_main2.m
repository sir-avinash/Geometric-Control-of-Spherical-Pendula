function double_pendulum_main2
...
[T,X]=ode45(@double_pendulum_dynamics,[0 1],x0,options);
 Fs=90;
...
B=  [zeros(3);eye(3)];   %  [zeros(3);hat(q2)];   ;
...
function u = double_pendulum_controller(q1,q2,dq2,w1,w2,J,G,C,B)
