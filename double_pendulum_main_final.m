...
%%%%%%%%%% Definin Initial Conditions %%%%%%%%%
q10 = Rx(-70*pi/180)*Ry(-20*pi/180)*d.e3;
w10 = [0 2.5 0]';
w10 = trans_map(q10,w10);

%%%% The following variable 'pert' can be used to rotate q2 to any position
%%%% that is not equal to q2d. Default is q2d 
...
Lf2h = Fq2 + tmp*R*hat(q1)^2*Fq1 + tmp*R*hat(q1)*hat(dq1)*w1 + hat(dq2)*hat(q2)*w2d + hat(q2)*hat(dq2)*w2d ;
